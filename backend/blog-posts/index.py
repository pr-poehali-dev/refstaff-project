...
ТЕКУЩИЙ ГОД: {current_year}. Упоминай год ТОЛЬКО если это органично для темы (например, "тренды найма" или "изменения в HR"). Не вставляй год в заголовок и текст искусственно — большинство тем универсальны и не требуют привязки к году.
