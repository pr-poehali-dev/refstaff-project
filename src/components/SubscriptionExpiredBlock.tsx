...
export function SubscriptionExpiredBlock({ onRenew, isEmployee = false }: SubscriptionExpiredBlockProps) {
  return (
          ...
          {isEmployee ? (
            <div className="bg-white/80 rounded-lg p-6">
              <p className="text-gray-600">
                Свяжитесь с работодателем для восстановления доступа
              </p>
            </div>
          ) : (
          ...
          {!isEmployee && onRenew && (
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-500">
                ...
                <a href="mailto:info@i-hunt.ru" className="text-primary hover:underline">info@i-hunt.ru</a>
              </p>
            </div>
          )}
        </CardContent>
