...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: '92% кандидатов по рекомендациям проходят испытательный срок против 67% с job-досок. Рекомендатель несёт репутационную ответственность, поэтому советует только тех, в ком уверен.',
  },
  {
    question: 'Как выплачиваются вознаграждения сотрудникам?',
    answer: 'Вознаграждение выплачивается любым удобным для вас способом. Компания сама настраивает размер бонуса для каждой вакансии.',
  },
];
