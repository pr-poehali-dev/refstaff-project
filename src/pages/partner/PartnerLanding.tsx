          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                ...
                { n: '4', icon: 'Wallet', title: 'Выводите деньги', desc: 'После 30-дневного hold-периода, будет доступен запрос на вывод средств' },
              ].map(s => (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: 'Как происходит выплата комиссии?', a: 'После каждой оплаты вашего клиента комиссия начисляется на ваш баланс в личном кабинете. После 30-дневного hold-периода, вы сможете запросить вывод и получить денежные средства.' },
